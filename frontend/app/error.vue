...
<template>
  <div class="relative min-h-screen overflow-hidden bg-bg text-text">
    ...
    <main
      class="relative mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 py-6 sm:px-6 lg:px-8"
    >
      <div class="grid w-full gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
        <section
          class="relative overflow-hidden rounded-3xl border border-border bg-secondary/55 p-6 sm:p-8 lg:p-10"
        >
          <div class="mb-10 flex items-center justify-between gap-4">
            ...
            <div
              class="flex items-center gap-2 rounded-full border border-border bg-bg/60 px-3 py-2 text-sm text-light-gray"
            >
          ...
          <div class="mb-6 flex items-center gap-4">
            <div
              class="flex h-14 w-14 items-center justify-center rounded-2xl border border-border bg-bg/80 text-primary"
            >
            ...
            <div class="flex flex-wrap items-center gap-3">
              <div
                class="rounded-full border border-border bg-bg/80 px-4 py-2 text-sm text-light-gray"
              >
                Код {{ statusCode }}
              </div>
              <div
                class="rounded-full border border-border bg-bg/80 px-4 py-2 text-sm text-light-gray break-words"
              >
                {{ statusMessage }}
              </div>
            </div>
            ...
            <div class="space-y-3">
              <div class="rounded-2xl border border-border bg-secondary/70 p-4">
                ...
                <p class="text-sm leading-6 text-light-gray">
                  Нажмите «Попробовать снова», если ошибка возникла во время загрузки или обновления
                  данных.
                </p>
              </div>
              <div class="rounded-2xl border border-border bg-secondary/70 p-4">
                ...
                <p class="text-sm leading-6 text-light-gray">
                  Если вы пришли по ссылке или из списка задач, шаг назад часто сразу возвращает в
                  рабочий поток.
                </p>
              </div>
              <div class="rounded-2xl border border-border bg-secondary/70 p-4">
                ...
                <p class="text-sm leading-6 text-light-gray">
                  Кнопка «В обзор» отправит вас в основной раздел дашборда и сбросит текущее
                  состояние ошибки.
                </p>
              </div>
            </div>
            ...
            <div class="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
              ...
              <div class="rounded-2xl border border-border bg-bg/70 p-4">
                ...
                <p class="mt-2 text-lg font-medium">
                  {{ isNotFound ? "Навигация" : "Выполнение" }}
                </p>
              </div>
              <div class="rounded-2xl border border-border bg-bg/70 p-4">
