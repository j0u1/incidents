...
Моно-репозиторий системы управления инцидентами с маршрутизацией обращений. Позволяет регистрировать и отслеживать инциденты. В сервисе реализована авторизация пользователя. Фичи реализованы как отдельный модуль, который может быть независимо подключён или отключён без изменения основной архитектуры приложения.

> ⚠️ Мультипользовательский режим в разработке
>
> ⚠️ Не весь функционал готов

![превью сайта](./frontend/public/images/preview.webp)
